    ...
    const fv = FormValidation.formValidation(formValidationExamples, {
      fields: {
        ...
        formValidationBio: {
          validators: {
            ...
            stringLength: {
              min: 25,
              max: 200,
              message: 'The bio must be more than 25 and less than 200 characters long'
            }
          }
        },
        formValidationAlamat: {
            validators: {
              notEmpty: {
                message: 'Please enter your alamat'
              },
              stringLength: {
                min: 5,
                max: 200,
                message: 'The Alamat must be more than 5 and less than 200 characters long'
              }
            }
        },
        ...
        formValidationQty: {
            validators: {
              ...
              stringLength: {
                min: 1,
                max: 10,
                message: 'The Qty must be more than 0 and less than 10 characters long'
              }
            }
          },
